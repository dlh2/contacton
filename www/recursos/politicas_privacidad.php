<div id="politicas_privacidad" class="modal fade" role="dialog">  <div class="modal-dialog modal-lg">    <!-- Modal content-->    <div class="modal-content">      <div class="modal-header">        <button type="button" class="close" data-dismiss="modal">×</button>        <h4 class="modal-title">          Políticas de Privacidad        </h4>      </div>      <div class="modal-body">        <strong>ContactON</strong>
			...
			<br/><br/>
				<strong>El usuario podrá ejercer en cualquier momento su derecho de acceso, corrección, actualización, rectificación, cancelación y oposición de sus datos,</strong> utilizando el e-mail o la clave y la password incluida al darse de alta o poniéndose en contacto con <b>ContactON</b>
			<br/><br/>
				Es responsabilidad del titular de los datos la exactitud de los mismos, así como su puesta al día, que está facilitada por la herramienta del sistema "modificar el currículo" o "solicitar modificación Datos de Empresa". Podrá, asimismo, eliminar totalmente sus datos a través de la herramienta "eliminar c.v." o "baja del servicio".
			<br/><br/>
			...
			<div class="well well-sm text-justify">
				...
				<ul>
					<li> Que introducen los datos personales en una Base de Datos, destinada a facilitarles oportunidades de acceso a ofertas de trabajo publicadas por empresas.
					<li> Que los datos que obligatoriamente deben cubrir son los estrictamente necesarios para facilitar la función de búsqueda en la Base de datos por parte de aquellas empresas expresamente autorizadas por <b>ContactON</b>.
					<li> Que tienen la posibilidad de mantener sus datos personales en la privacidad, dejando sólo manifiestos los pertenecientes a su perfil profesional. Si, una vez localizados éstos por las empresas autorizadas éstas deseasen ponerse en contacto con tales usuarios, <b>ContactON</b> solicitará cada uno la autorización para facilitar dicho contacto entre la empresa concreta y el usuario, pudiéndo rechazar esta posibilidad.
					<li> Que de forma permanente tienen posibilidad de acceso a su página personal a través de su e-mail y password, para rectificar, modificar y cancelar totalmente y de forma directa todos sus datos y los servicios específicos solicitados por los usuarios(newsletter, alertas, etc).
					<li> Que sus datos son tratados por aquellas Empresas oferentes a las que voluntariamente el profesional envía su demanda de empleo, y por las autorizadas expresamente por <b>ContactON</b> para consultar su base de datos, pudiendo, en este caso, proteger sus datos personales a través del nivel de privacidad de su currículo, como anteriormente se ha expresado.
				</ul>
			</div>
		...
		<strong>Recepción automática de Alertas</strong>
			<div class="well well-sm text-justify">
				 El alta en este servicio se realiza al introducir los datos en <strong>ContactON</strong>.
				 <br/><br/>
				 <b>ContactON</b> incluirá en estos mensajes automáticos otras informaciones que considere de interés para el usuarios, como cursos, eventos, etc. 
			</div>
		<strong>Política de Cookies</strong>
			<div class="well well-sm text-justify">
				Las cookies son pequeños archivos de texto que se descargan en tu ordenador cuando visitas nuestro Sitio, que contienen los datos de sesión que pueden ser útiles más adelante en la página web. Estos facilitan que se mantenga tu información al navegar entre las páginas, y permiten analizar la forma de interactuar con el Sitio.
				<br/><br/>
				Las cookies son seguras: sólo pueden almacenar la información que facilita el navegador que utilices, la que hayas introducido tú mismo en el navegador, o la información incluida en la solicitud de la página concreta. Las cookies no pueden ejecutar código, y no pueden ser utilizadas para acceder a tu pc.
				<br/><br/>
				Las cookies son esenciales para que Internet funcione: facilitan la prestación de servicios interactivos, y favorecen la navegación y usabilidad de la web. No pueden causar ningún daño a su ordenador, y en el caso de error, permiten identificarlo y solucionarlo.
				<br/><br/>
				Hay diferentes tipos de cookies para distintas funciones:
				<ul>
				<li><b>Cookies permanentes</b>: se almacenan en el disco duro y la página web las lee cada vez que se realiza una nueva visita. Aunque se llaman “permanentes”, tienen una duración limitada. A partir de una fecha determinada, dejan de funcionar. Estas cookies facilitan los diferentes servicios que prestan los Sitios web.</li>
				<li><b>Cookies de sesión</b>: son temporales. No se almacenan en el disco duro, sino en el archivo de cookies de tu navegado, y desaparecen cuando abandonas el Sitio Web. Ofrecen información útil para analizar pautas de tráfico en la web. Este análisis ofrece pautas para mejorar el contenido y facilitar la usabilidad</li>
				</ul>
				Las cookies que utilizamos son:
				<ul>
				<li>Las <b>cookies necesarias</b>, porque sirven para la correcta navegación, permiten realizar el pago de servicios solicitados por el usuario o sirven para asegurar la correcta carga del contenido de la página web.</li>
				</ul>
			</div>
		<strong>Gestión de las cookies: Garantías</strong>
			<div class="well well-sm text-justify">
				Los diferentes navegadores de Internet , en su configuración o en las opciones, permiten desactivar las cookies o limitar su funcionamiento. El método para hacerlo varía de uno a otro, pero en la Ayuda ofrecen las pautas para hacerlo.
				<br /><br />
				En muchos de ellos está prevista la posibilidad de activar un modo “privado” o “incógnito”, que borra las cookies después de cada visita. Te ofrecemos diferentes enlaces  a esta facilidad de Gestión de las cookies.
				<ul>
				<li><a href="http://windows.microsoft.com/es-es/windows-vista/block-or-allow-cookies" target="_blank"><b>Internet Explorer 8</b> y superior; InPrivate</a></li>
				<li><a href="http://support.apple.com/kb/ht1677?viewlocale=es_es&locale=es_es"  target="_blank"><b>Safari 2</b> y superior; Navegación Privada</a></li>
				<li><a href="http://help.opera.com/Windows/11.50/es-ES/cookies.html" target="_blank"><b>Opera 10.5</b> y superior; Navegación Privada</a></li>
			...
			<div class="well well-sm text-justify">
				...
				<br/><br/>
				En cuanto no esté expresamente indicado en este documento, <b>ContactON</b>, se somete a lo dispuesto en la legislación vigente en la materia. De forma especial, a la L.O. 15/1999, de 13 de Diciembre, de Protección de Datos de Carácter Personal (BOE 14-12-1999) y a la Ley 34/2002, de 11 de Julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (BOE 12-07-2002).
				<br/><br/>
