...
<link rel="stylesheet" type="text/css" href="http://cpanel.nixiweb.com/images/index/styles.css" />
</head>
<body>
<div id="container">
  ...
  <div id="listingcontainer">
	...
	if($dirok) {
	?>
      <div><a href="<?=$dotdotdir;?>" class="<?=$class;?>"><img src="http://cpanel.nixiweb.com/images/index/dirup.png" alt="Folder" /><strong>..</strong> <em>-</em>
	...
	for($i=0;$i<$arsize;$i++) {
	?>
      <div><a href="<?=$leadon.$dirs[$i];?>" class="<?=$class;?>"><img src="http://cpanel.nixiweb.com/images/index/folder.png" alt="<?=$dirs[$i];?>" /><strong>
        <?=$dirs[$i];?>
        </strong> <em>-</em>
	...
	?>
      <div><a href="<?=$fileurl;?>" class="<?=$class;?>"<?=$thumb2;?>><img src="http://cpanel.nixiweb.com/images/index/<?=$icon;?>" alt="<?=$files[$i];?>" /><strong>
        <?=$filename;?>
        </strong> <em>
